...
function love.keypressed(key)
    ...
    -- pause and restart the game and the main music
end
...
function love.update(dt)
    ...
    stop background when game is paused
    ]]
    
    -- pause the scrolling during the paused mode, and during the TitleScreen, Score and Countdown states
...
function love.draw()
    ...
    if scrolling == false and playing == true then 
        love.graphics.draw(blackGround, -groundScroll, VIRTUAL_HEIGHT - 16)
    end
